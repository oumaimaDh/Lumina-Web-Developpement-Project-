...
require_once $basePath . DIRECTORY_SEPARATOR . 'controller' . DIRECTORY_SEPARATOR . 'AIMatchingController.php';
                ...
                <div class="application-details" style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin: 20px 0;">
                    ...
                    <div class="application-content">
                        ...
                        <div class="cv-section">
                            ...
                            $basePath = realpath(dirname(__DIR__));
                            $fullPath = $basePath . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . $cvFilename;
                            
                            if (file_exists($fullPath)): ?>
                                <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                                    <span style="color: var(--primary-medium); font-size: 0.95rem; flex: 1; min-width: 200px;">
                                        <i class="fas fa-file-pdf" style="margin-right: 6px; color: #dc3545;"></i>
                                        <?= $cvFilename ?>
                                    </span>
                                    <a href="<?= $publicCvPath ?>" target="_blank" class="btn btn-outline" download style="background: white; color: var(--primary-dark); border: 2px solid var(--primary-light); padding: 8px 16px; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; white-space: nowrap;">
