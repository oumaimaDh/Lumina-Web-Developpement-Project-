...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'submit_application') {
    ...
    require_once 'C:\xampp\htdocs\project_lumina - tache1+tache2 +tache3\Controllerj\OfferController.php';
    require_once 'C:\xampp\htdocs\project_lumina - tache1+tache2 +tache3\Controllerj\AssociationController.php';
            ...
            <form class="application-form" id="application-form" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="full-name" name="full_name" required placeholder="Your first and last name">
                            <small class="field-msg" id="full-name-msg"></small>
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone</label>
                            <input type="tel" id="phone" name="phone" required placeholder="+216 XXXXXXXX" maxlength="12" inputmode="numeric">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="profession" name="profession" required placeholder="Developer, Accountant...">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" id="desired-salary" name="desired_salary" required placeholder="Ex: 1800 (≥ 300)" min="300">
                            <small class="field-msg" id="desired-salary-msg"></small>
                        </div>
                        <div class="form-group">
                            <label for="preferred-location">Preferred Location</label>
                            <select id="preferred-location" name="preferred_location" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="skills" name="skills" required placeholder="JavaScript, React, Communication, Project Management..." rows="3"></textarea>
                        <small class="field-msg" id="skills-msg"></small>
                    </div>
                    <div class="form-group">
                        <label for="experience">Professional Experience</label>
                        <textarea id="experience" name="experience" required placeholder="Briefly describe your background, previous positions, and key achievements..." rows="4"></textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload">
                            <input type="file" id="cv-upload" name="cv_file" accept=".pdf,.doc,.docx" required>
